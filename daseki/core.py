...
class HalfInning(common.ParentMixin):
    ...
    def plateAppearances(self):
        ...
        [<daseki.plateAppearance.PlateAppearance 8-1: gyorj001:W>,
         ...
         <daseki.plateAppearance.PlateAppearance 8-4: hundn001:FC6/G.3XH(62);2-3>,
         <daseki.plateAppearance.PlateAppearance 8-5: denoc001:S9/G.3-H;1-2>,
         <daseki.plateAppearance.PlateAppearance 8-6: cabre001:W.2-3;1-2>,
         ...
         <daseki.plateAppearance.PlateAppearance 8-11: amara001:K>]
        '''
