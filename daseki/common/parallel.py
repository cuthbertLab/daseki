    ...
    with Parallel(n_jobs=numCpus) as para:
        ...
        while totalRun < iterLength:
            ...
            if updateFunction is True:
                print(f'Done {totalRun} tasks of {iterLength}')
...
def runNonParallel(
    ...
    for i in range(iterLength):
        ...
        if updateFunction is True and i % updateMultiply == 0:
            print(f'Done {i} tasks of {iterLength} not in parallel')
...
def multicore(func):
    ...
    '''
        ...
        >>> gameList = ['SDN201304090', 'SFN201409280', 'SLN201408140',
        ...             'SLN201408160', 'WAS201404250']
